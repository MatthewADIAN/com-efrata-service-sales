...
{
    public class CCGEmbroideryApprovalReportControllerTest : BaseMonitoringControllerTest<CCGEmbroideryApprovalReportController, CCGEmbroideryApprovalReportViewModel, ICCGEmbroideryApprovalReport>
    {
    }
