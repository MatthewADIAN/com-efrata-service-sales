...
{
    public class ProfitGarmentByComodityReportControllerTest : BaseMonitoringControllerTest<ProfitGarmentByComodityReportController, ProfitGarmentByComodityReportViewModel, IProfitGarmentByComodityReport>
    {
    }
