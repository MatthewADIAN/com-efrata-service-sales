...
{
    public class CCROGarmentHistoryBySectionReportControllerTest : BaseMonitoringControllerTest<CCROGarmentHistoryBySectionReportController, CCROGarmentHistoryBySectionReportViewModel, ICCROGarmentHistoryBySectionReport>
    {
    }
