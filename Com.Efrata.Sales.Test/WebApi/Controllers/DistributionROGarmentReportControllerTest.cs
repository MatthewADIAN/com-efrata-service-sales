...
{
    public class DistributionROGarmentReportControllerTest : BaseMonitoringControllerTest<DistributionROGarmentReportController, DistributionROGarmentReportViewModel, IDistributionROGarmentReport>
    {
    }
