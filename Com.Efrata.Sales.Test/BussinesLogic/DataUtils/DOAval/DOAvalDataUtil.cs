...
namespace Com.Efrata.Sales.Test.BussinesLogic.DataUtils.DOAval
{
    public class DOAvalDataUtil : BaseDataUtil<DOAvalFacade, DOSalesModel>
    {
        public DOAvalDataUtil(DOAvalFacade facade) : base(facade)
        {
        }
