using AutoMapper;
using Com.Efrata.Sales.Test.BussinesLogic.DataUtils.SpinningSalesContractDataUtil;
...
namespace Com.Efrata.Sales.Test.BussinesLogic.Facades.SpinningSalesContract
{
