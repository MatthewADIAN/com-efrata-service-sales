using AutoMapper;
using Com.Efrata.Sales.Test.BussinesLogic.DataUtils.FinisihingPrintingSalesContract;
using Com.Efrata.Sales.Test.BussinesLogic.DataUtils.ProductionOrder;
using Com.Efrata.Sales.Test.BussinesLogic.Utils;
using Com.Efrata.Service.Sales.Lib;
using Com.Efrata.Service.Sales.Lib.AutoMapperProfiles.ProductionOrderProfiles;
...
using Com.Efrata.Service.Sales.Lib.ViewModels.FinishingPrinting;
using Com.Efrata.Service.Sales.Lib.ViewModels.FinishingPrintingCostCalculation;
...
using Com.Efrata.Service.Sales.Lib.ViewModels.Report;
using Moq;
...
namespace Com.Efrata.Sales.Test.BussinesLogic.Facades.ProductionOrder
{
