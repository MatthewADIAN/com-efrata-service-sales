using AutoMapper;
using Com.Efrata.Sales.Test.BussinesLogic.DataUtils.FinishingPrintingPreSalesContract;
...
namespace Com.Efrata.Sales.Test.BussinesLogic.Facades.FinishingPrintingPreSalesContract
{
