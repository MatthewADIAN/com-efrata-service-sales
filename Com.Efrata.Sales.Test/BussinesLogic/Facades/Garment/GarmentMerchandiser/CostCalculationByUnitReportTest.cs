...
namespace Com.Efrata.Sales.Test.BussinesLogic.Facades.Garment.GarmentMerchandiser
{
    public class CostCalculationByUnitReportTest 
   {
        ...
        protected virtual Mock<IServiceProvider> GetServiceProviderMock(SalesDbContext dbContext)
        {
            ...
            CostCalculationByUnitReportLogic costCalculationByUnitReportLogic = new CostCalculationByUnitReportLogic(identityService, dbContext, clientServiceMock.Object);
