...
{
    public class ProfitGarmentByComodityReportTest
    {
        private const string ENTITY = "CostCalculationByComodityReport";
        ...
        protected virtual Mock<IServiceProvider> GetServiceProviderMock(SalesDbContext dbContext)
        {
            ...
            serviceProviderMock
                .Setup(x => x.GetService(typeof(ProfitGarmentByComodityReportLogic)))
                .Returns(profitgarmentByComodityReportLogic);
        ...
        public async void Get_Excel_Success()
        {
            ...
            var Response = profitgarmentByComodityReportLogic.GenerateExcel(filter: JsonConvert.SerializeObject(filter));
