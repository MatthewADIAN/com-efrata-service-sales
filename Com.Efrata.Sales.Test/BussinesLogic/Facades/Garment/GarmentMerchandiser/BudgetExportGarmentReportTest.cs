...
{
    public class BudgetExportGarmentReportTest
    {
        private const string ENTITY = "BudgetExportGarmentReport";
        ...
        protected virtual Mock<IServiceProvider> GetServiceProviderMock(SalesDbContext dbContext)
        {
            ...
            BudgetExportGarmentReportLogic budgetexportgarmentReportLogic = new BudgetExportGarmentReportLogic(identityService, dbContext, clientServiceMock.Object);
            ...
            serviceProviderMock
                .Setup(x => x.GetService(typeof(BudgetExportGarmentReportLogic)))
                .Returns(budgetexportgarmentReportLogic);
        ...
        public async void Get_Report_Success()
        {
            ...
            IBudgetExportGarmentReport budgetexportgarmentReport = new BudgetExportGarmentReportFacade(serviceProvider, dbContext);
        ...
        public async void Get_Excel_Success()
        {
            ...
            var Response = budgetexportgarmentReport.GenerateExcel(filter: JsonConvert.SerializeObject(filter));
