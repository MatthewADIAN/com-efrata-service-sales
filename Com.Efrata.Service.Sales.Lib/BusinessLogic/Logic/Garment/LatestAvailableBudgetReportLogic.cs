...
{
    public class LatestAvailableBudgetReportLogic : BaseMonitoringLogic<CostCalculationGarment>
    {
        private SalesDbContext dbContext;
        private readonly IIdentityService identityService;

        public LatestAvailableBudgetReportLogic(SalesDbContext dbContext, IIdentityService identityService)
        {
