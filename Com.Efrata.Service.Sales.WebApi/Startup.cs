...
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Facades.Spinning;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Facades.FinishingPrinting;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Facades.Weaving;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Logic.Spinning;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Logic.FinishingPrinting;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Logic.Weaving;
...
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Interface.Weaving;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Interface.Spinning;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Interface.FinishingPrinting;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Interface.ProductionOrder;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Facades.ProductionOrder;
...
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Logic.GarmentSalesContractLogics;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Interface.GarmentSalesContractInterface;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Facades.GarmentSalesContractFacades;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Facades;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Interface.ROGarmentInterface;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Facades.ROGarment;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Interface;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Logic.ROGarmentLogics;
...
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Logic.GarmentBookingOrderLogics;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Interface.GarmentBookingOrderInterface;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Facades.GarmentBookingOrderFacade;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Interface.Garment.WeeklyPlanInterfaces;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Facades.GarmentMasterPlan.WeeklyPlanFacades;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Logic.GarmentMasterPlan.WeeklyPlanLogics;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Interface.GarmentMasterPlan.MonitoringInterfaces;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Facades.GarmentMasterPlan.MonitoringFacades;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Logic.GarmentMasterPlan.MonitoringLogics;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Facades.GarmentMasterPlan.GarmentSewingBlockingPlanFacades;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Interface.GarmentMasterPlan.GarmentSewingBlockingPlanInterfaces;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Logic.GarmentMasterPlan.GarmentSewingBlockingPlanLogics;
...
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Logic.GarmentMasterPlan.MaxWHConfirmLogics;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Facades.GarmentPreSalesContractFacades;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Interface.GarmentPreSalesContractInterface;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Logic.GarmentPreSalesContractLogics;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Interface.GarmentOmzetTargetInterface;
...
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Interface.SalesInvoice;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Facades.SalesInvoice;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Logic.SalesInvoice;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Logic.FinishingPrintingCostCalculation;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Interface.FinishingPrintingCostCalculation;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Facades.FinishingPrintingCostCalculation;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Interface.LocalMerchandiserInterfaces;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Facades.LocalMerchandiserFacades;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Logic.DOSales;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Interface.DOSales;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Facades.DOSales;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Facades.DOReturn;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Interface.DOReturn;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Logic.DOReturn;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Facades.DeliveryNoteProduction;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Interface.SalesInvoiceExport;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Facades.SalesInvoiceExport;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Logic.SalesInvoiceExport;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Facades.DOAval;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Interface.DOAval;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Logic.DOAval;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Logic.DOStock;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Facades.DOStock;
using Com.Efrata.Service.Sales.Lib.BusinessLogic.Interface.DOStock;

namespace Com.Efrata.Service.Sales.WebApi
{
    public class Startup
    {
        ...
        {
            Com.Efrata.Service.Sales.WebApi.Utilities. APIEndpoint.Core = Configuration.GetValue<string>("CoreEndpoint") ?? Configuration["CoreEndpoint"];
			Com.Efrata.Service.Sales.WebApi.Utilities.APIEndpoint.AzureCore = Configuration.GetValue<string>("AzureCoreEndpoint") ?? Configuration["AzureCoreEndpoint"];
			Com.Efrata.Service.Sales.Lib.Helpers.APIEndpoint.StorageAccountName = Configuration.GetValue<string>("StorageAccountName") ?? Configuration["StorageAccountName"];
			Com.Efrata.Service.Sales.Lib.Helpers.APIEndpoint.StorageAccountKey = Configuration.GetValue<string>("StorageAccountKey") ?? Configuration["StorageAccountKey"];
            Com.Efrata.Service.Sales.Lib.Helpers.APIEndpoint.AzurePurchasing = Configuration.GetValue<string>("AzurePurchasingEndpoint") ?? Configuration["PurchasingEndpoint"];
            Com.Efrata.Service.Sales.Lib.Helpers.APIEndpoint.Core = Configuration.GetValue<string>("CoreEndpoint") ?? Configuration["CoreEndpoint"];
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            Com.Efrata.Service.Sales.Lib.Helpers.APIEndpoint.ConnectionString = connectionString;
            /* Register */
